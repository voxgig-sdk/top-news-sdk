...
func registerSDKWords(r *eng.Registry, client *sdk.TopNewsSDK) {
...
func runOp(client *sdk.TopNewsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
