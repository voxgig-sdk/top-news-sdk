...
from topnews_sdk.utility import register

# Load features
from topnews_sdk.feature.base_feature import TopNewsBaseFeature
from topnews_sdk.features import _has_feature, _make_feature
...
class TopNewsSDK:
    ...
    def get_utility(self):
        return TopNewsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TopNewsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def TopNew(self, data=None) -> "TopNewEntity":
        ...
        from topnews_sdk.entity.top_new_entity import TopNewEntity
