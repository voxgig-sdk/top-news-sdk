...
from topnews_sdk.core.helpers import get_ctx_prop, to_map
...
class TopNewsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TopNewsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TopNewsError(code, msg, self)
