# TopNews SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TopNewsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TopNewsSDK(...) and TopNewsSDK.test(...) become
#      TopNewsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "topnews_sdk"
_SDK_CLASS = "TopNewsSDK"
