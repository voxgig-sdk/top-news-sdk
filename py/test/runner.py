...
class TopNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TopNewsTestRunner.getenv("TOPNEWS_TEST_LIVE")
        override = TopNewsTestRunner.getenv("TOPNEWS_TEST_OVERRIDE")
        ...
        explain = TopNewsTestRunner.getenv("TOPNEWS_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["TOPNEWS_TEST_EXPLAIN"] = explain
