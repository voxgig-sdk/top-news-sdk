...
type Args struct {
	Entity string         `json:"entity" jsonschema:"top_new"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TopNewsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "top-news_list",
		Description: "List records from TopNews. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "top-news_load",
		Description: "Load a single record from TopNews. " +
...
func runOp(client *sdk.TopNewsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TopNewsSDK, name string) (sdk.TopNewsEntity, error) {
	switch strings.ToLower(name) {
	case "top_new":
		return client.TopNew(nil), nil
