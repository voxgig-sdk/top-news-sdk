...
func NewTopNewEntity(client *core.TopNewsSDK, entopts map[string]any) *TopNewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TopNewEntity) GetName() string { return e.name }
...
func (e *TopNewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TopNewEntity) Deleted() bool {
	return e.deleted
}


func (e *TopNewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTopNewEntity(e.client, opts)
}

func (e *TopNewEntity) Data(args ...any) any {
...
func (e *TopNewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TopNew; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TopNewEntity) DataTyped(data ...TopNew) TopNew {
	if len(data) > 0 {
		return typedFrom[TopNew](e.Data(asMap(data[0])))
	}
	return typedFrom[TopNew](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TopNew (all fields
// optional at the wire level).
func (e *TopNewEntity) MatchTyped(match ...TopNew) TopNew {
	if len(match) > 0 {
		return typedFrom[TopNew](e.Match(asMap(match[0])))
	}
	return typedFrom[TopNew](e.Match())
}
...
func (e *TopNewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TopNewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TopNewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TopNewListMatch and returns []TopNew. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TopNewEntity) ListTyped(reqmatch TopNewListMatch, ctrl map[string]any) ([]TopNew, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TopNew](res), nil
}



func (e *TopNewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TopNewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TopNewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TopNewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
