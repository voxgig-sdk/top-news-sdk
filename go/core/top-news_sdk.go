...
func (sdk *TopNewsSDK) OptionsMap() map[string]any {
...
func (sdk *TopNewsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TopNewsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TopNewsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TopNewsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TopNewsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TopNewsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TopNewsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TopNewsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TopNewsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TopNewsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
