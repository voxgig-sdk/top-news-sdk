...
|---|---|---|
| `ts/` | @voxgig-sdk/top-news-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/top-news-sdk \
      --repository voxgig-sdk/top-news-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/top-news-sdk` shows it, and
`npm trust revoke @voxgig-sdk/top-news-sdk --id=<id>` removes it.
