...
class TopNewsNetsimFeature extends TopNewsBaseFeature
{
    ...
    private function _simulate(TopNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TopNewsContext $ctx, array $applied): void
    {
        $client = $this->client;
