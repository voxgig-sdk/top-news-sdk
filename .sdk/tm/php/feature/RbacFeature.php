...
class TopNewsRbacFeature extends TopNewsBaseFeature
{
    ...
    private function _required(TopNewsContext $ctx): ?string
    {
    ...
    private function _reject(TopNewsContext $ctx, string $required): void
    {
    ...
    private function _track(TopNewsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
