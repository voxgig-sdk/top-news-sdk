...
class TopNewsTimeoutFeature extends TopNewsBaseFeature
{
    ...
    private function _with_timeout(TopNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TopNewsContext $_ctx, float $ms): void
    {
        $client = $this->client;
