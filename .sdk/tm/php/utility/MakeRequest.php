...
// TopNews SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TopNewsMakeRequest
{
    public static function call(TopNewsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TopNewsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TopNewsResponse($fetched);
        } else {
