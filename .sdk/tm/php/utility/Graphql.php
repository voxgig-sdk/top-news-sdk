...
class TopNewsGraphql
{
    ...
    // equivalent.
    public static function body(TopNewsContext $ctx): mixed
    {
    ...
    public static function errors(TopNewsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
