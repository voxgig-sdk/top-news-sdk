...
// TopNews SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TopNewsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TopNewsOmni::structfix($now, Struct::undef()))
                        !== json_encode(TopNewsOmni::structfix($val, Struct::undef()))) {
