...
// TopNews SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TopNewsSDK::test)
...
{
    private const SDK_CLASS = 'TopNewsSDK';
    ...
    private const SDK_BASE = 'topnews_sdk';
