...
class TopNewDirectTest extends TestCase
{
    public function test_direct_list_top_new(): void
    {
        $setup = top_new_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-top_new", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
