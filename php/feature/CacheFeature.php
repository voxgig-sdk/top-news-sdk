...
class TopNewsCacheFeature extends TopNewsBaseFeature
{
    ...
    private function _through(TopNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
