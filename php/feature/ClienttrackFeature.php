...
// TopNews SDK clienttrack feature
...
class TopNewsClienttrackFeature extends TopNewsBaseFeature
{
    ...
    public function PostConstruct(TopNewsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TopNews-SDK';
