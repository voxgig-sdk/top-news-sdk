...
class TopNewsStreamingFeature extends TopNewsBaseFeature
{
    ...
    private function _iterate(TopNewsResult $result): \Generator
    {
    ...
    private function _streamable(TopNewsContext $ctx): bool
    {
