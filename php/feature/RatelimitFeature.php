...
class TopNewsRatelimitFeature extends TopNewsBaseFeature
{
    ...
    private function _acquire(TopNewsContext $ctx): void
    {
    ...
    private function _track(TopNewsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
