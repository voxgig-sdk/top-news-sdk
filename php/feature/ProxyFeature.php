...
class TopNewsProxyFeature extends TopNewsBaseFeature
{
    ...
    public function init(TopNewsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TopNewsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
