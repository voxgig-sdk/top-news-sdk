...
// TopNews SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TopNewsTestFeature extends TopNewsBaseFeature
{
    ...
    public function init(TopNewsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TopNewsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TopNewsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TopNewsContext $ctx, $op, $args): array
    {
