...
class TopNewsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TopNewsSDK/1.0)';
    ...
    public static function call(TopNewsContext $ctx, string $fullurl, array $fetchdef): array
    {
