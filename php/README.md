...
print_r(array_map(fn($item) => $item->data_get(), $topnew));
```
...
```
php/
├── topnews_sdk.php          -- Main SDK class
...
The main class (`topnews_sdk.php`) exports the SDK class
