...
function envOverride(m) {
    if ('TRUE' === process.env.TOP_NEWS_TEST_LIVE ||
        'TRUE' === process.env.TOP_NEWS_TEST_OVERRIDE) {
    ...
    m.TOP_NEWS_TEST_EXPLAIN = process.env.TOP_NEWS_TEST_EXPLAIN || m.TOP_NEWS_TEST_EXPLAIN;
    return m;
}
