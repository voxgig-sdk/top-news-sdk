...
(0, node_test_1.describe)('TopNewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-top_new', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-top_new', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TopNewsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.TOP_NEWS_APIKEY,
        }));
        let idmap = env['TOP_NEWS_TEST_TOP_NEW_ENTID'];
    ...
    const client = new __1.TopNewsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TopNewDirect.test.js.map