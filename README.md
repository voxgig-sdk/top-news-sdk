...
This API provides the top news articles from a specified country in a specific language for a given date.

Learn more about Top News API at [worldnewsapi.com](https://worldnewsapi.com).
...
const items = await client.TopNew().list({ language: "example", source_country: "example" })
```
