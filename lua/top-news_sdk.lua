...
TopNewsSDK._make_feature = _make_feature


function TopNewsSDK.new(options)
  local self = setmetatable({}, TopNewsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TopNewsSDK:options_map()
...
function TopNewsSDK:get_utility()
  return Utility.copy(self._utility)
end


function TopNewsSDK:get_root_ctx()
  return self._rootctx
end


function TopNewsSDK:prepare(fetchargs)
...
function TopNewsSDK:direct(fetchargs)
...
-- by passing it.
function TopNewsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TopNewsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TopNewsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TopNewsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TopNewsSDK.new(sdkopts)
  sdk.mode = "test"
