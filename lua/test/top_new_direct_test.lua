...
describe("TopNewDirect", function()
  it("should direct-list-top_new", function()
    local setup = top_new_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-top_new", setup.live and "live" or "unit")
...
function top_new_direct_setup(mockres)
